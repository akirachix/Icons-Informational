...
const Footer = () => {
    return(
        ...
        <div className='footer' id='contactpage'>
      <div className='contains'>
        ...
        <div className='social'>
            ...
            <div>
            <img src="/Images/twitter.png" alt="" className='photos'></img>
            </div>
        ...
        <div>
            <h1 className='copyright'>copyright@Edukeri2024. All right reserved.</h1>
